                ...
                <div className="card bg-dark border-0 shadow-lg" style={{ maxWidth: '400px', width: '100%' }}>
                    <div className="card-body p-5">
                        ...
                        <div className="text-center mt-3">
                            <Link to="/register" className="text-danger text-decoration-none">¿No tienes una cuenta? Regístrate</Link>
                        </div>
                        <div className="text-center mt-3">
                            <a href="#" className="text-danger text-decoration-none">¿Olvidaste tu contraseña?</a>
                        </div>
                    </div>
                </div>
            </div>
