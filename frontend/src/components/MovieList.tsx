    ...
    return (
        <div className="mb-8">
            ...
            <div className="relative group">
                <div ref={scrollRef} className="flex overflow-x-auto scrollbar-hide space-x-4 px-4">
                    {movies.map(movie => (
                        <Link to={`/movie/${movie.id}`} key={movie.id} className="flex-none w-48">
                            <motion.div
                            ...
                            >
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="font-semibold truncate text-white">{movie.title || movie.name}</h3>
